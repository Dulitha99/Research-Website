                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex space-x-3">
                      <button
                        ...
                        className="flex-1 bg-indigo-600 text-white px-4 py-2 rounded-lg font-semibold flex items-center justify-center space-x-2 hover:bg-indigo-700 transition-all duration-300 cursor-pointer"
                        type="button"
                      ...
                      <button
                        ...
                        className="flex-1 border-2 border-indigo-600 text-indigo-400 px-4 py-2 rounded-lg font-semibold flex items-center justify-center space-x-2 hover:bg-indigo-600 hover:text-white transition-all duration-300 cursor-pointer"
                        type="button"
                        style={{ zIndex: 10, position: 'relative' }}
                      >
              ...
              {presentations.map((presentation, index) => (
                ...
                >
                  ...
                  <div className="flex-1 bg-gray-800 rounded-lg p-6 shadow-lg border border-gray-700">
                    ...
                    <p className="text-gray-300 mb-4">{presentation.description}</p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            >
              ...
              <h3 className="text-lg font-bold text-white mb-2">Total Presentations</h3>
              <p className="text-gray-300 text-sm">Comprehensive research coverage</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-300 text-sm">Presentations delivered</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-300 text-sm">Scheduled presentations</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-300 text-sm">Research milestones covered</p>
            </motion.div>
          </div>
        </div>
      </section>
